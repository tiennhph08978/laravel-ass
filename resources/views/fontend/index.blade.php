					    ...
					    <div class="banner" >
								...
								@foreach($slides as $sl)
						            ...
						            <div class="slotholder" style="width:100%;height:100%;" data-duration="undefined" data-zoomstart="undefined" data-zoomend="undefined" data-rotationstart="undefined" data-rotationend="undefined" data-ease="undefined" data-bgpositionend="undefined" data-bgposition="undefined" data-kenburns="undefined" data-easeme="undefined" data-bgfit="undefined" data-bgfitend="undefined" data-owidth="undefined" data-oheight="undefined">
													<div class="tp-bgimg defaultimg" data-lazyload="undefined" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat" data-lazydone="undefined" src='{{asset("/upload/avatar/".$sl->image)}}' data-src='{{asset("/upload/avatar/".$sl->image)}}' style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url('{{asset('/upload/avatar/'.$sl->image)}}'); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;">
													</div>
												</div>
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="beta-products-list">
							<h4>San pham sale</h4>
							<div class="beta-products-details">
								<p class="pull-left">có {{count($sale_product)}} sp</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="product.html"><img src='{{asset("/upload/avatar/".$sale->image)}}' alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$sale->name}}</p>
											<p class="single-item-price">
												<span class="flash-del">{{number_format($sale->unit_price)}}đ</span>
												<span class="flash-share">{{number_format($sale->promotion_price)}}đ</span>	
											</p>
										</div>
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('Font.add-cart', $sale->pro_id)}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="product.html">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
