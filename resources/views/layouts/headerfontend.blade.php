			...
			<div class="container">
				...
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						...
						<li><a href="{{route('Auth.showLogin')}}">Đăng nhập</a></li>
					</ul>
				</div>
					...
					@if(Session::has('cart'))
						<div class="cart">
							...
							<div class="beta-dropdown cart-body">
								...
								<div class="cart-item">
								<a class="cart-item-delete" href="{{route('Font.del-cart',$product['item']['pro_id'])}}"><i class="fa fa-times"></i></a>
									<div class="media">
										<a class="pull-left" href="#"><img src="{{asset('/upload/avatar/'.$product['item']['image'])}}" alt=""></a>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						<li><a href="{{route('Font')}}">Trang chủ</a></li>
